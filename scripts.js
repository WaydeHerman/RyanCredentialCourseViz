...
function generateGraph(data, root_key) {
        ...
        if (
            ...
            nodes.forEach(function (v) {
                if (v.parent === null) {
                    ...
                    v.data.data.values.forEach(function (w, i) {
                        if (w !== null) {
                            nodes.forEach(function (u) {
                                if (
                                    u.data.data.key !== v.data.data.key &&
                                    u.parent !== null
                                ) {
                                    u.data.data.values.forEach(function (o, j) {
                                        if (o !== null) {
                                            if (o.key === w.key) {
                                                if (
                                                    listOfConnections.indexOf(
                                                        u.data.data.key + "" + v.data.data.key
                                                    ) < 0
                                                ) {
                                                    ...
                                                    links.push({
                                                        ...
                                                        target: v,
                                                        id: links.length,
                                                        ref: u.data.data.key + "" + v.data.data.key,
                                                        value: 1
                                                    });
                                                } else {
    ...
    function showTooltip(d) {
        ...
        d3.select(".tooltip-name").text(d["Micro-credential Name"])
            .on("click", function () {
                window.open(
                    d["Direct Link to MC on the platform"],
                    '_blank'
                );
            })
        ...
        d3.select(".tooltip-topic").text("Topic: " + d["Topics"]);
